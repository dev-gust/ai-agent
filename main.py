...
def main() -> None:
    ...
    for _ in range(MAX_ITERS):
        try:
            final_response = generate_content(client, messages, args.user_prompt, args.verbose)
            if final_response:
...
def generate_content(client: OpenAI, messages: list, prompt: str, verbose: bool = False) -> str | None:
